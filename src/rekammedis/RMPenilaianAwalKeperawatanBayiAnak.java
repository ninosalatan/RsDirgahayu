...
public final class RMPenilaianAwalKeperawatanBayiAnak extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalKeperawatanBayiAnak(java.awt.Frame parent, boolean modal) {
        ...
        Label jlblSaturation = new Label();
        jlblSaturation.setText("Saturasi");
        jlblSaturation.setHorizontalAlignment(SwingConstants.CENTER);
        jlblSaturation.setBounds(842, 120, 40, 23);
        FormInput.add(jlblSaturation);
        
        txtSaturasi = new TextBox();
        txtSaturasi.setBounds(886, 119, 60, 23);
        FormInput.add(txtSaturasi);
    ...
    private void initComponents() {
        ...
        jLabel37.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        jLabel31.setBounds(802, 120, 30, 23);
        ...
        jLabel37.setBounds(726, 124, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_awal_keperawatan_ralan_bayi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",86,new String[]{
                    ...
                    NyeriHilang.getSelectedItem().toString(),KetNyeri.getText(),PadaDokter.getSelectedItem().toString(),KetDokter.getText(),Rencana.getText(),KdPetugas.getText(),txtSaturasi.getText()
                })==true){
