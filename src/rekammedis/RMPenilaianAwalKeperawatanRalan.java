...
public final class RMPenilaianAwalKeperawatanRalan extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalKeperawatanRalan(java.awt.Frame parent, boolean modal) {
        ...
        jlblSaturation.setBounds(869, 91, 40, 23);
        FormInput.add(jlblSaturation);
        
        txtSaturasi = new TextBox();
        txtSaturasi.setBounds(913, 90, 60, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_awal_keperawatan_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",58,new String[]{
                    ...
                    Durasi.getText(),NyeriHilang.getSelectedItem().toString(),KetNyeri.getText(),PadaDokter.getSelectedItem().toString(),KetDokter.getText(),Rencana.getText(),KdPetugas.getText(),txtSaturasi.getText()
                })==true){
