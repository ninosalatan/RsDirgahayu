...
public final class RMPenilaianAwalKeperawatanGigi extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalKeperawatanGigi(java.awt.Frame parent, boolean modal) {
        ...
        jlblSaturation.setBounds(863, 91, 40, 23);
        FormInput.add(jlblSaturation);
        
        txtSaturasi = new TextBox();
        txtSaturasi.setBounds(907, 90, 60, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_awal_keperawatan_gigi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",58,new String[]{
                    ...
                    KarangGigi.getSelectedItem().toString(),Gingiva.getSelectedItem().toString(),Palatum.getSelectedItem().toString(),Rencana.getText(),KdPetugas.getText(),txtSaturasi.getText()
                })==true){
