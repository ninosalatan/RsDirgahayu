...
public final class DlgPermintaanLaboratorium extends javax.swing.JDialog {
	...
	private ButtonGroup buttonGroupJnsPem;
    ...
    public DlgPermintaanLaboratorium(java.awt.Frame parent, boolean modal) {
        ...
        TNoPermintaan2.setDocument(new batasInput(15).getKata(TNoPermintaan2));
        ...
        Label jLabel7_1 = new Label();
        jLabel7_1.setHorizontalAlignment(SwingConstants.CENTER);
        jLabel7_1.setText("Pemeriksaan");
        jLabel7_1.setBounds(0, 100, 80, 23);
        PanelInput.add(jLabel7_1);
        
         buttonGroupJnsPem = new javax.swing.ButtonGroup();
         rbAnak = new widget.RadioButton();
         rbDewasa = new widget.RadioButton();
         rbDewasa.setBounds(95, 100, 80, 23);
         buttonGroupJnsPem.add(rbAnak);
        ...
        rbAnak.setBounds(163, 100, 80, 23);

        buttonGroupJnsPem.add(rbDewasa);
    ...
    protected void rbDewasaMouseClicked(MouseEvent evt) {
		// TODO Auto-generated method stub
    	tbTarifMouseClicked(evt);
	}

	protected void rbAnakMouseClicked(MouseEvent evt) {
		// TODO Auto-generated method stub
		tbTarifMouseClicked(evt);
	}
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(560, 155));
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(360, 150));
    ...
    */
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            FormInput.setPreferredSize(new Dimension(WIDTH,155));
