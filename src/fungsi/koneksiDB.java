...
//                System.out.println(EnkripsiAES.decrypt(prop.getProperty("HOST")));
//                System.out.println(EnkripsiAES.decrypt(prop.getProperty("PORT")));
...
//            System.out.println(EnkripsiAES.decrypt(prop.getProperty("SECRETKEYAPIBPJS")));
        }catch(Exception e){
            var=""; 
        }
        return var;
