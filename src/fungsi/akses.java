...
public final class akses {
    ...
    private static boolean aktif=false,admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            referensi_mobilejkn_bpjs=false,batal_pendaftaran_mobilejkn_bpjs=false,labu_darah=false,oksigen=false;
       ...
       try {                
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        akses.labu_darah=rs2.getBoolean("labu_darah");
                        akses.oksigen=rs2.getBoolean("oksigen");
    ...
    public static boolean getLabu_darah() {return akses.labu_darah;}
    public static boolean getOksiegen() {return akses.oksigen;}
}   
