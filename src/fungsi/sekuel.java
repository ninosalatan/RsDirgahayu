...
//            System.out.println(ps);
    ...
    public boolean menyimpanNew(String table,String filed,String value,String sama){
        try {
            ps=connect.prepareStatement("insert into "+table+" ("+filed+") values ("+value+")");
            ps.executeUpdate();
            if(ps != null){
                ps.close();
            }             
    ...
    public void menyimpanFiled(String table,String filed,String value,String sama) {
    	try {
            ps=connect.prepareStatement("insert into "+table+" ("+filed+") values ("+value+")");
            ps.executeUpdate();
            if(ps != null){
...
//            	System.out.println(ps);
    ...
    public void addItemCombo(String sql,JComboBox cmb) {
    	try {
            ...
            try{  
            	...
            	System.out.println("Notifikasi : "+err);
            }
        } catch (Exception e) {
            System.out.println("Notifikasi : "+e);
        } 
