...
import dirgahayu.DlgCariPeriksaLab;
import dirgahayu.DlgCariPeriksaLabPA;
import dirgahayu.DlgCariPeriksaRadiologi;
import dirgahayu.DlgCariPoli;
import dirgahayu.DlgPeriksaLaboratorium;
import dirgahayu.DlgPeriksaLaboratoriumPA;
import dirgahayu.DlgPeriksaRadiologi;
import dirgahayu.DlgRawatJalan;
import dirgahayu.DlgTagihanOperasi;
 ...
 * @author perpustakaan
 */
public class DlgBilingRalanNew extends javax.swing.JDialog {
    ...
    private String nota_jalan="",dokterrujukan="",polirujukan="",status="",biaya="",tambahan="",totals="",kdptg="",nmptg="",kd_pj="",notaralan="",centangdokterralan="",
            ...
            sqlpscarirm="select no_rkm_medis,png_jawab from reg_periksa \n"
            		+ "Inner join penjab on penjab.kd_pj=reg_periksa.kd_pj where no_rawat=?",
     ...
     * @param parent
     * @param modal */
    public DlgBilingRalanNew(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelJenisBayar.setName("jLabelJenisBayar"); // NOI18N
        jLabelJenisBayar.setPreferredSize(new java.awt.Dimension(65, 23));
        panelGlass1.add(jLabelJenisBayar);
        jLabelBayar.setText("");
        jLabelBayar.setName("jLabelBayar"); // NOI18N
        jLabelBayar.setPreferredSize(new java.awt.Dimension(120, 23));
        panelGlass1.add(jLabelBayar);
...
private void MnPeriksaLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPeriksaLabActionPerformed
    ...
    private void MnPenjabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenjabActionPerformed
    	...
    	String Status_bayar=Sequel.cariIsi("SELECT status_bayar FROM sik.reg_periksa where no_rawat='"+TNoRw.getText()+"'");
    	if(Status_bayar.equals("Sudah Bayar")) {
    		JOptionPane.showMessageDialog(null, "Transaksi Pembayaran Sudah Selesai.,Tidak dapat di rubah");
    	}else {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBilingRalanNew dialog = new DlgBilingRalanNew(new javax.swing.JFrame(), true);
    ...
    private widget.Label jLabelBayar;
	    ...
	    try{
            ...
            try{
                ...
                if(rscarirm.next()){
                    ...
                    jLabelBayar.setText(rscarirm.getString(2));
                }
	    }catch (Exception e) {
                TNoRM.setText("");
                System.out.println("Notifikasi : "+e);
