    ...
    */
    ...
    public void isRawat() {
         try {      
            ...
            pscarirm=koneksi.prepareStatement("select no_rkm_medis,png_jawab from reg_periksa Inner join penjab on penjab.kd_pj=reg_periksa.kd_pj where no_rawat=?");
            try {
