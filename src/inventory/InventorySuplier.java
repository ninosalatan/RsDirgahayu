...
public class InventorySuplier extends javax.swing.JDialog {
    ...
    private int i;
	private TextBox tNpwp;
	private TextBox tKodePos;
    ...
    public InventorySuplier(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Supplier","Nama Supplier","Alamat Supplier","Kota","No.Telp","Nama Bank","No.Rekening","NPWP","Kode Pos"};
        ...
        Label labelnpwp = new Label();
        labelnpwp.setBounds(0, 106, 90, 23);
        labelnpwp.setText("NPWP");
        FormInput.add(labelnpwp);
        
        tNpwp = new TextBox();
        tNpwp.setBounds(94, 106, 310, 23);
        FormInput.add(tNpwp);
        
        Label labelkodepos = new Label();
        labelkodepos.setBounds(426, 106, 100, 23);
        labelkodepos.setText("Kode Pos");
        FormInput.add(labelkodepos);
        
        tKodePos = new TextBox();
        tKodePos.setBounds(530, 106, 190, 23);
        FormInput.add(tKodePos);
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(660, 135));
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"datasuplier","kode_suplier","?","kode_suplier=?,nama_suplier=?,alamat=?,kota=?,no_telp=?,nama_bank=?,rekening=?,npwp=?,kode_pos=?",10,new String[]{
                Kd.getText(),Nm.getText(),Alamat.getText(),Kota.getText(),Telp.getText(),Bank.getText(),NoRek.getText(),tNpwp.getText(),tKodePos.getText(),tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()
            });
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("datasuplier","?,?,?,?,?,?,?,?,?","Kode Supplier",9,new String[]{
                Kd.getText(),Nm.getText(),Alamat.getText(),Kota.getText(),Telp.getText(),Bank.getText(),NoRek.getText(),tNpwp.getText(),tKodePos.getText()
            })==true){
                tampil();
                emptTeks();
            }                
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select datasuplier.kode_suplier, datasuplier.nama_suplier, "+
                    " datasuplier.alamat,datasuplier.kota, datasuplier.no_telp,"+
                    " datasuplier.nama_bank,datasuplier.rekening,datasuplier.npwp,datasuplier.kode_pos from datasuplier "+
