...
private void btnGudangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGudangActionPerformed
    ...
    private void NoOrderKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoOrderKeyPressed
        // TODO add your handling code here:
    	if(evt.getKeyCode()==KeyEvent.VK_SPACE) {
    	DlgCariSuratPemesanan cariPesanan=new DlgCariSuratPemesanan(null,false);
    	this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    	cariPesanan.emptTeks();
    	cariPesanan.isCek();
    	cariPesanan.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    	cariPesanan.setLocationRelativeTo(internalFrame1);
    	cariPesanan.setAlwaysOnTop(false);
    	cariPesanan.setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());
    	}
