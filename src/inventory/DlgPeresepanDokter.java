...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    public DlgPeresepanDokter(java.awt.Frame parent, boolean modal) {
        ...
        tabModeResep=new DefaultTableModel(null,new Object[]{
                ...
                "Harga(Rp)","Jenis Obat","Aturan Pakai","I.F.","H.Beli","Stok","Keterangan"
            }){
            @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if ((colIndex==0)||(colIndex==1)||(colIndex==8)||(colIndex==12)) {
                    a=true;
                }
                return a;
             }
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            int reply = JOptionPane.showConfirmDialog(rootPane,"Apakah Anda akan Menyimpan data ini..??","Konfirmasi",JOptionPane.YES_NO_OPTION);
            if (reply == JOptionPane.YES_OPTION) {                 
                ...
                if(ubah==false){
                    if(Sequel.menyimpantf2("resep_obat","?,?,?,?,?,?,?,?","Nomer Resep",9,new String[]{
                        ...
                        cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),status,"Belum Lunas"
                        })==true){
                            simpandata();
                    }else{
                        emptTeksobat();
                        ...
                        try {
                            ...
                            if(carikapasitas.next()){ 
                                if(Sequel.menyimpantf2("resep_dokter","?,?,?,?","data",4,new String[]{
                                    ...
                                    tbResep.getValueAt(i,9).toString()
                                })==false){
                                    sukses=false;
                                }
                            }else{
