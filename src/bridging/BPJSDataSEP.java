    ...
    public void bodyWithDeleteRequest() throws Exception {
	    ...
	    headers.add("X-Signature",api.getHmac(utc));
            ...
            if(nameNode.path("code").asText().equals("200")){
                ...
                Sequel.meghapus("diagnosa_pasien","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString());
                Sequel.meghapus("rujuk_masuk","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString());
                Sequel.meghapus("reg_periksa","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString());
                Sequel.meghapus("kamar_inap","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString());
                tampil();
                emptTeks();
            }else{
                JOptionPane.showMessageDialog(null,nameNode.path("message").asText());
