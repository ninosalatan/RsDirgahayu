...
import keuangan.DlgKasirRalanNew;
...
public final class DlgKasirRalan extends javax.swing.JDialog {
	...
	private DlgRawatJalanNew dlgrwjl2 = new DlgRawatJalanNew(null, false);
	...
	private double ttljmdokter = 0, ttljmperawat = 0, ttlkso = 0, ttljasasarana = 0, ttlbhp = 0, ttlmenejemen = 0,
			ttlpendapatan = 0;
	private JMenuItem MnMeninggalDOA;
	private JMenu MnStatusIGD;
	...
	public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
		...
		tabModekasir2 = new DefaultTableModel(null,
				new String[] { "Kd.Dokter", "Dokter Rujukan", "Nomer RM", "Pasien", "Poliklinik Rujukan",
						...
						"Tanggal", "Jam", "Kode Poli", "Kode PJ", "No.Telp Pasien" }) {
			@Override
			public boolean isCellEditable(int rowIndex, int colIndex) {
				return false;
			}
			...
			public void windowClosed(WindowEvent e) {
				if (akses.getform().equals("DlgKasirRalan")) {
					if (billing.penjab.getTable().getSelectedRow() != -1) {
						if (filter.equals("no")) {
							kdpenjab.setText(billing.penjab.getTable()
									.getValueAt(billing.penjab.getTable().getSelectedRow(), 1).toString());
							nmpenjab.setText(billing.penjab.getTable()
									.getValueAt(billing.penjab.getTable().getSelectedRow(), 2).toString());
						} else if (filter.equals("yes")) {
							caripenjab = billing.penjab.getTable()
									.getValueAt(billing.penjab.getTable().getSelectedRow(), 1).toString();
							TabRawatMouseClicked(null);
						}
					}
	...
	private void initComponents() {
		...
		mnPemintaanLab = new javax.swing.JMenuItem();
		mnPemintaanLabPA = new javax.swing.JMenuItem();
		mnPermintaanRadiologi = new javax.swing.JMenuItem();
		...
		mnPemintaanLab.setBackground(new java.awt.Color(255, 255, 254));
		mnPemintaanLab.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
		mnPemintaanLab.setForeground(new java.awt.Color(50, 50, 50));
		mnPemintaanLab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
		mnPemintaanLab.setText("Permintaan Lab");
		mnPemintaanLab.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
		mnPemintaanLab.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
		mnPemintaanLab.setName("MnPeriksaLab"); // NOI18N
		mnPemintaanLab.setPreferredSize(new java.awt.Dimension(220, 26));
		mnPemintaanLab.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				MnPeriksaLabActionPerformed(evt);
			}
		});
		MnTindakanRalan.add(mnPemintaanLab);

		mnPemintaanLabPA.setBackground(new java.awt.Color(255, 255, 254));
		mnPemintaanLabPA.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
		mnPemintaanLabPA.setForeground(new java.awt.Color(50, 50, 50));
		mnPemintaanLabPA.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
		mnPemintaanLabPA.setText("Permintaan Lab PA");
		mnPemintaanLabPA.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
		mnPemintaanLabPA.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
		mnPemintaanLabPA.setName("MnPeriksaLabPA"); // NOI18N
		mnPemintaanLabPA.setPreferredSize(new java.awt.Dimension(220, 26));
		mnPemintaanLabPA.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				MnPeriksaLabPAActionPerformed(evt);
			}
		});
		//MnTindakanRalan.add(mnPemintaanLabPA);
		...
		mnPermintaanRadiologi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
		mnPermintaanRadiologi.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
		mnPermintaanRadiologi.setName("MnPeriksaRadiologi"); // NOI18N
		mnPermintaanRadiologi.setPreferredSize(new java.awt.Dimension(220, 26));
		mnPermintaanRadiologi.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		MnTindakanRalan.add(mnPermintaanRadiologi);
		...
		MnStatusIGD=new javax.swing.JMenu();
		MnStatusIGD.setBackground(new java.awt.Color(250, 255, 245));
		MnStatusIGD.setForeground(new java.awt.Color(50, 50, 50));
		MnStatusIGD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
		MnStatusIGD.setText("Set Status IGD");
		MnStatusIGD.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
		MnStatusIGD.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
		MnStatusIGD.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
		MnStatusIGD.setName("MnStatus"); // NOI18N
		MnStatusIGD.setPreferredSize(new java.awt.Dimension(200, 26));
		...
		MnStatusIGD.add(MnDIrawat);

		MnMeninggalDOA=new javax.swing.JMenuItem();
		MnMeninggalDOA.setBackground(new java.awt.Color(255, 255, 254));
		MnMeninggalDOA.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
		MnMeninggalDOA.setForeground(new java.awt.Color(50, 50, 50));
		MnMeninggalDOA.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
		MnMeninggalDOA.setText("DOA");
		MnMeninggalDOA.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
		MnMeninggalDOA.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
		MnMeninggalDOA.setName("MnMeninggalDOA"); // NOI18N
		MnMeninggalDOA.setPreferredSize(new java.awt.Dimension(180, 26));
		MnMeninggalDOA.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				MnMeninggalActionPerformed(evt);
			}
		});
		MnStatusIGD.add(MnMeninggalDOA);
		...
		internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
				javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)),
				"::[ Daftar Pasien Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11),
				new java.awt.Color(50, 50, 50))); // NOI18N
		...
		cmbStatus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "Belum", "Sudah", "Batal",
				"Berkas Diterima", "Dirujuk", "Meninggal", "Dirawat", "Pulang Paksa" }));
...
//                                billing.setLocationRelativeTo(internalFrame1);
//                                billing.setVisible(true);
								DlgKasirRalanNew bill = new DlgKasirRalanNew(null, false);
								bill.SetNoRm(TNoRw.getText());
								bill.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
								bill.setLocationRelativeTo(internalFrame1);
...
//				periksalab.setVisible(true);
	...
	private void BtnSimpan5ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpan5ActionPerformed
		...
		if (kdpenjab.getText().trim().equals("") || nmpenjab.getText().trim().equals("")) {
			...
			Sequel.menyimpan("ubah_penjab",
					"'" + TNoRw.getText() + "',now(),'" + kdpj + "','" + kdpenjab.getText() + "'");
			tampilkasir();
			WindowCaraBayar.dispose();
		}
			...
			if (tbKasirRalan2.getSelectedRow() != -1) {
				if (Sequel.cariInteger("select count(no_rawat) from kamar_inap where no_rawat=?",
					...
					if (Sequel.cariRegistrasi(
						...
						dlgrwjl.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 10).toString(),
								tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 0).toString(),
		...
		if (tabModekasir2.getRowCount() == 0) {
			...
			if (tbKasirRalan2.getSelectedRow() != -1) {
				if (Sequel.cariInteger("select count(no_rawat) from kamar_inap where no_rawat=?",
					...
					periksalab.setLocationRelativeTo(internalFrame1);
					periksalab.emptTeks();
					periksalab.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 10).toString(),
							"Ralan");
					periksalab.setDokterPerujuk(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 0).toString(),
							tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 1).toString());
					periksalab.isCek();
					periksalab.setVisible(true);
				}
		...
		if (tabModekasir2.getRowCount() == 0) {
			...
			if (tbKasirRalan2.getSelectedRow() != -1) {
				if (Sequel.cariInteger("select count(no_rawat) from kamar_inap where no_rawat=?",
					...
					periksarad.emptTeks();
					periksarad.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 10).toString(),
							"Ralan");
					periksarad.setDokterPerujuk(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 0).toString(),
							tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 1).toString());
					periksarad.tampil();
					periksarad.isCek();
			...
			if (tbKasirRalan2.getSelectedRow() != -1) {
				if (Sequel.cariInteger("select count(no_rawat) from kamar_inap where no_rawat=?",
					...
					if (Sequel.cariRegistrasi(
						...
						dlgobt.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 10).toString(),
								tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 2).toString(),
								tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 3).toString(),
								...
								Sequel.cariIsi("select jam_reg from reg_periksa where no_rawat='"
										...
										+ "'"));
						dlgobt.isCek();
						dlgobt.setDokter(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 0).toString(),
								tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(), 1).toString());
						dlgobt.tampilobat();
...
//                                billing.setVisible(true);
	...
	private void MnSEPActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_MnSEPActionPerformed
		if (tabModekasir.getRowCount() == 0) {
			...
			if (tbKasirRalan.getSelectedRow() != -1) {
				...
				dlgki.isCek();
				dlgki.setNoRm2(TNoRw.getText(), Valid.SetTgl2(Tanggal.getText()), "2. Ralan", "IGDK", "Unit IGD/UGD",
						tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 0).toString());
					...
					try {
						...
						if (rskasir.next()) {
							if (rskasir.getString("no_peserta").length() < 13) {
								...
								form.setNoRm(TNoRw.getText(), rskasir.getString("no_peserta"), TNoRM.getText(),
										rskasir.getString("nm_pasien"), rskasir.getString("tgl_lahir"),
										rskasir.getString("jk"));
								form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
								form.setLocationRelativeTo(internalFrame1);
								form.setVisible(true);
								this.setCursor(Cursor.getDefaultCursor());
	...
	private void MnCetakSuratSakitPihak2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_MnCetakSuratSakitPihak2ActionPerformed
		if (tabModekasir.getRowCount() == 0) {
			...
			if (tbKasirRalan.getSelectedRow() != -1) {
				...
				resume.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
				resume.setLocationRelativeTo(internalFrame1);
				resume.setNoRm(TNoRw.getText(), tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(), 6).toString(),
						DTPCari1.getDate(), DTPCari2.getDate());
				resume.tampil();
				resume.setVisible(true);
				this.setCursor(Cursor.getDefaultCursor());
	...
	private javax.swing.JMenuItem mnPemintaanLab;
	private javax.swing.JMenuItem MnPeriksaLab1;
	private javax.swing.JMenuItem mnPemintaanLabPA;
			...
			try {
				...
				while (rskasir.next()) {
					tabModekasir.addRow(new String[] { rskasir.getString(5), rskasir.getString(6), rskasir.getString(7),
							...
							rskasir.getString(14), rskasir.getString("no_rawat"), rskasir.getString("tgl_registrasi"),
							rskasir.getString("jam_reg"), rskasir.getString(1), rskasir.getString("status_bayar"),
							rskasir.getString("status_poli"), rskasir.getString("kd_pj"), rskasir.getString("kd_poli"),
	...
	public void isCek() {
		...
		mnPemintaanLab.setEnabled(akses.getpermintaan_lab());
		MnPeriksaLab1.setEnabled(akses.getpermintaan_lab());
		mnPemintaanLabPA.setEnabled(akses.getpermintaan_lab());
		MnPeriksaLabPA2.setEnabled(akses.getpermintaan_lab());
		 ...
		 * 
		 * if((MnRMIGD.isVisible()==false)&&(MnRMRawatJalan.isVisible()==false)&&(
		 * MnHemodialisa.isVisible()==false)&&(ppResume.isVisible()==false)&&(MnDiagnosa
		 * .isVisible()==false)&&(ppRiwayat.isVisible()==false)&&(ppDeteksiDIniCorona.
		 * isVisible()==false)){ MnDataRM.setVisible(false); }
		 * 
		 ...
		 * 
		 * if((MnDataRalan.isVisible()==false)&&(MnPeriksaLab.isVisible()==false)&&(
		 ...
		 * (MnNoResep.isVisible()==false)){ MnObatRalan.setVisible(false); }
		 * 
		 * if((MnBilling.isVisible()==false)&&(MnBillingParsial.isVisible()==false)){
		 * MnPilihBilling.setVisible(false); }
		 * 
		 * if((MnRekapHarianDokter.isVisible()==false)&&(MnRekapHarianParamedis.
		 * isVisible()==false)&&(MnRekapBulananDokter.isVisible()==false)&&(
		 * MnRekapBulananParamedis.isVisible()==false)&&(MnRekapHarianPoli.isVisible()==
		 * false)&&(MnRekapHarianObat.isVisible()==false)){ MnRekap.setVisible(false); }
		 * 
		...
		if (Sequel.cariRegistrasi(TNoRw.getText()) == 0) {
			try {
				...
				if (sukses == true) {
					...
					sukses = jur.simpanJurnal(TNoRw.getText(), Sequel.cariIsi("select current_date()"), "U",
							"TINDAKAN RAWAT JALAN PASIEN " + TNoRw.getText() + " DIPOSTING OLEH " + akses.getkode());
				}
				...
				if (sukses == true) {
					...
					System.out.println(
							"Terjadi kesalahan saat pemrosesan data, transaksi tindakan otomatis dibatalkan!!");
					Sequel.RollBack();
				}
