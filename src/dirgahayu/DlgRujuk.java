...
public final class DlgRujuk extends javax.swing.JDialog {
        ...
        penyakit.addWindowListener(new WindowListener() {
			...
			public void windowClosed(WindowEvent e) {
				...
				if (penyakit.getTabel().getSelectedRow()!=-1) {
					TDiagnosa.setText(penyakit.getTabel().getValueAt(penyakit.getTabel().getSelectedRow(),2).toString());
				}
	                KdDok.requestFocus();
			}
    ...
    private void initComponents() {
        ...
        TDiagnosa.setBounds(75, 100, 278, 23);
        ...
        Button btnIcd10 = new Button();
        btnIcd10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png")));
        btnIcd10.addActionListener(new ActionListener() {
        	@Override
			public void actionPerformed(ActionEvent e) {
        		 btnIcd10ActionPerformed(e);
        	}
        });
        btnIcd10.setMnemonic('2');
        btnIcd10.setBounds(363, 100, 28, 23);
    ...
    protected void btnIcd10ActionPerformed(ActionEvent e) {
		// TODO Auto-generated method stub
