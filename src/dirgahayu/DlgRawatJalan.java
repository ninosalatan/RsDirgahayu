...
public final class DlgRawatJalan extends javax.swing.JDialog {
	...
	private Table tbPemeriksaanVaksin;
	...
	public DlgRawatJalan(java.awt.Frame parent, boolean modal) {
		...
		for (i = 0; i < tableModePemeriksaanVaksin.getColumnCount(); i++) {
		...
		TabModeTindakan = new DefaultTableModel(null,
				new Object[] { "P", "Kode", "Nama Perawatan", "Kategori Perawatan", "Tarif/Biaya", "Bagian RS", "BHP",
						"JM Dokter", "JM Perawat", "KSO", "Menejemen", "Jenis Bayar" }) {
			@Override
			public boolean isCellEditable(int rowIndex, int colIndex) {
				boolean a = false;
				if (colIndex == 0) {
		...
		TabModeTindakan3 = new DefaultTableModel(null,
				new Object[] { "P", "Kode", "Nama Perawatan", "Poli", "Tarif/Biaya", "Bagian RS",
						"BHP", "JM Dokter", "JM Perawat", "KSO", "Menejemen", "Jenis Bayar" }) {
			@Override
			public boolean isCellEditable(int rowIndex, int colIndex) {
				boolean a = false;
				if (colIndex == 0) {
		...
		for (i = 0; i < TabModeTindakan3.getColumnCount(); i++) {
		...
		jLabelPoli.setHorizontalAlignment(SwingConstants.CENTER);
		jLabelPoli.setText("Poli :");
		jLabelPoli.setBounds(564, 10, 34, 23);
		FormInput.add(jLabelPoli);
		...
		TInstruksi.setDocument(new batasInput(400).getKata(TInstruksi));
	...
	private void initComponents() {
		...
		TabRawat.addTab("Pemeriksaan Vaksin", internalFrame9);
		...
		internalFrame9.add(PanelInputVaksin, java.awt.BorderLayout.PAGE_START);
		...
		internalFrame9.add(ScrollVaksin, java.awt.BorderLayout.CENTER);

		ChkInputVaksn = new widget.CekBox();
		ChkInputVaksn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/143.png"))); // NOI18N
		...
		ChkInputVaksn.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/143.png"))); // NOI18N
		ChkInputVaksn.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/145.png"))); // NOI18N
		ChkInputVaksn.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/145.png"))); // NOI18N
		...
		jLabelvaksin = new widget.Label();
		jLabelvaksin.setText("Petugas :");
		jLabelvaksin.setName("jLabelvaksin"); // NOI18N
		...
		BtnSeekPetugasVaksin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
		BtnSeekPetugasVaksin.setMnemonic('p');
		BtnSeekPetugasVaksin.setToolTipText("ALt+4");
		BtnSeekPetugasVaksin.setName("BtnSeekPetugasVaksin"); // NOI18N
		...
		JLabelImunVaksi.setName("JLabelImunVaksi"); // NOI18N
		...
		JLabelTinggiVaksi.setName("JLabelTinggiVaksi"); // NOI18N
		...
		JLabelObjectVaksi.setName("JLabelObjectVaksi"); // NOI18N
		...
		JLabelalergiVaksi.setName("JLabelalergiVaksi"); // NOI18N
		...
		JLabelRespirasiVaksi.setName("JLabelRespirasiVaksi"); // NOI18N
		panelGlassVaksin.add(JLabelRespirasiVaksi);
		JLabelRespirasiVaksi.setBounds(606, 125, 100, 23);

		Label JLabelGCSVaksi = new widget.Label();
		JLabelGCSVaksi.setText("GCS(E,V,M) :");
		JLabelGCSVaksi.setName("JLabelGCSVaksi"); // NOI18N
		...
		TtensiVaksn.setBounds(544, 124, 55, 23);
		...
		JLabelLingkarDD.setHorizontalAlignment(SwingConstants.LEFT);
		JLabelLingkarDD.setText("Lingkar Dada :");
		JLabelLingkarDD.setBounds(739, 44, 70, 23);
		panelGlassVaksin.add(JLabelLingkarDD);

		TlinkardadaVksn = new TextBox();
		TlinkardadaVksn.setBounds(814, 44, 66, 23);
		...
		JLabelDiagnosaVksn.setBounds(461, 160, 68, 23);
		panelGlassVaksin.add(JLabelDiagnosaVksn);

		Tkdvksin = new TextBox();
		Tvksin = new TextBox();
		Tkdvksin.setBounds(543, 159, 100, 23);
		panelGlassVaksin.add(Tkdvksin);

		Tvksin = new TextBox();
		Tvksin.setBounds(648, 159, 201, 23);
		panelGlassVaksin.add(Tvksin);

		BtnAddVaksin = new widget.Button();
		BtnAddVaksin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/plus_16.png"))); // NOI18N
...
//        BtnAddVaksin.setToolTipText("Alt+3");
		...
		BtnAddVaksin.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				vaksin.isCek();
				vaksin.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
				vaksin.setLocationRelativeTo(internalFrame1);
				vaksin.setVisible(true);
			}
		});
		panelGlassVaksin.add(BtnAddVaksin);
		BtnAddVaksin.setBounds(852, 160, 28, 23);
		...
		BtnPeniliaianAwalKeperawatanKebidanan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
		...
		BtnPeniliaianAwalKeperawatanKebidanan.setName("BtnPeniliaianAwalKeperawatanKebidanan"); // NOI18N
...
//								SimpanPenangananDokterPetugas();
			...
			case 4:
				if (kdptgsVasksin.getText().trim().equals("")) {
					...
					if (Sequel.menyimpantf("pemeriksaan_vaksin", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 17,
							new String[] { TNoRw.getText(), Valid.SetTgl(DTPTgl.getSelectedItem() + ""),
									cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":"
											+ cmbDtk.getSelectedItem(),
		...
		case 0:
			if (tabModeDr.getRowCount() == 0) {
				...
				for (i = 0; i < tbRawatDr.getRowCount(); i++) {
					if (tbRawatDr.getValueAt(i, 0).toString().equals("true")) {
						if (Sequel.cariRegistrasi(tbRawatDr.getValueAt(i, 1).toString()) > 0) {
							...
							if (Sequel.queryutf(
									"delete from rawat_jl_dr where no_rawat='" + tbRawatDr.getValueAt(i, 1).toString()
											+ "' and kd_jenis_prw='" + tbRawatDr.getValueAt(i, 10) + "' and kd_dokter='"
				...
				if (sukses == true) {
					...
					if (ttljasasarana > 0) {
						Sequel.menyimpan("tampjurnal",
								"'" + Beban_Jasa_Sarana_Tindakan_Ralan + "','Beban Jasa Sarana Tindakan Ralan','0','"
										+ ttljasasarana + "'",
				...
				for (i = 0; i < tbRawatPr.getRowCount(); i++) {
					if (tbRawatPr.getValueAt(i, 0).toString().equals("true")) {
						if (Sequel.cariRegistrasi(tbRawatPr.getValueAt(i, 1).toString()) > 0) {
							...
							if (Sequel.queryutf(
									"delete from rawat_jl_pr where no_rawat='" + tbRawatPr.getValueAt(i, 1).toString()
											+ "' and kd_jenis_prw='" + tbRawatPr.getValueAt(i, 10) + "' and nip='"
			...
			if (tabModeDr.getRowCount() == 0) {
				...
				Valid.MyReportqry("rptJalanDr.jasper", "report", "::[ Data Rawat Jalan Yang Ditangani Dokter ]::",
						"select rawat_jl_dr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
								...
								+ "dokter inner join rawat_jl_dr " + "on rawat_jl_dr.no_rawat=reg_periksa.no_rawat "
								+ "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
								+ "and rawat_jl_dr.kd_jenis_prw=jns_perawatan.kd_jenis_prw "
								+ "and rawat_jl_dr.kd_dokter=dokter.kd_dokter " + "where " + tgl
								+ " and rawat_jl_dr.no_rawat like '%" + TCari.getText().trim() + "%' or " + tgl
								...
								+ "and rawat_jl_dr.kd_dokter like '%" + TCari.getText().trim() + "%' or " + tgl
			...
			if (tabModePr.getRowCount() == 0) {
				...
				Valid.MyReportqry("rptJalanPr.jasper", "report", "::[ Data Rawat Jalan Yang Ditangani Perawat ]::",
						"select rawat_jl_pr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
								...
								+ "from pasien inner join reg_periksa inner join jns_perawatan inner join "
								+ "petugas inner join rawat_jl_pr " + "on rawat_jl_pr.no_rawat=reg_periksa.no_rawat "
								+ "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
								+ "and rawat_jl_pr.kd_jenis_prw=jns_perawatan.kd_jenis_prw "
								+ "and rawat_jl_pr.nip=petugas.nip where  " + tgl + "and rawat_jl_pr.no_rawat like '%"
								+ TCari.getText().trim() + "%' or " + tgl + "and reg_periksa.no_rkm_medis like '%"
								+ TCari.getText().trim() + "%' or " + tgl + "and pasien.nm_pasien like '%"
								+ TCari.getText().trim() + "%' or " + tgl + "and jns_perawatan.nm_perawatan like '%"
								+ TCari.getText().trim() + "%' or " + tgl + "and rawat_jl_pr.nip like '%"
								+ TCari.getText().trim() + "%' or " + tgl + "and petugas.nama like '%"
								+ TCari.getText().trim() + "%' or " + tgl + "and rawat_jl_pr.tgl_perawatan like '%"
								+ TCari.getText().trim() + "%'  " + "order by rawat_jl_pr.no_rawat desc",
						param);
			}
			break;
		case 2:
			if (tabModeDrPr.getRowCount() == 0) {
				...
				Valid.MyReportqry("rptJalanDrPr.jasper", "report", "::[ Data Rawat Jalan Yang Ditangani Dokter ]::",
						"select tindakan_rajal.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
								...
								+ "and tindakan_rajal.kd_dokter=dokter.kd_dokter " + "and tindakan_rajal.nip=petugas.nip "
								+ "where " + tgl + " and tindakan_rajal.no_rawat like '%" + TCari.getText().trim()
								...
								+ tgl + "and tindakan_rajal.kd_dokter like '%" + TCari.getText().trim() + "%' or " + tgl
								+ "and dokter.nm_dokter like '%" + TCari.getText().trim() + "%' or " + tgl
	...
	private void TabRawatMouseClicked(java.awt.event.MouseEvent evt) {
		// System.out.print(TabRawat.getSelectedIndex());
		switch (TabRawat.getSelectedIndex()) {
		case 0:
	...
	private widget.ScrollPane ScrollVaksin;
	...
	private void tampilDrPr() {
		...
		try {
			ps3 = koneksi.prepareStatement("select tindakan_rajal.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
					+ "concat(tindakan_rajal.kd_jenis_prw,' ',jns_perawatan.nm_perawatan),tindakan_rajal.kd_dokter,dokter.nm_dokter,"
					+ "tindakan_rajal.nip,petugas.nama,tindakan_rajal.tgl_perawatan,tindakan_rajal.jam_rawat,tindakan_rajal.biaya_rawat,tindakan_rajal.kd_jenis_prw, "
					+ "tindakan_rajal.tarif_tindakandr,tindakan_rajal.tarif_tindakanpr,tindakan_rajal.kso,tindakan_rajal.material,tindakan_rajal.bhp,tindakan_rajal.menejemen  "
					+ "from pasien inner join reg_periksa inner join jns_perawatan inner join "
					+ "dokter inner join tindakan_rajal inner join petugas on tindakan_rajal.no_rawat=reg_periksa.no_rawat "
					+ "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and tindakan_rajal.kd_jenis_prw=jns_perawatan.kd_jenis_prw "
					+ "and tindakan_rajal.kd_dokter=dokter.kd_dokter and tindakan_rajal.nip=petugas.nip "
					+ "where tindakan_rajal.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and tindakan_rajal.no_rawat like ? or "
					+ "tindakan_rajal.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and reg_periksa.no_rkm_medis like ? or "
					+ "tindakan_rajal.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and pasien.nm_pasien like ? or "
					+ "tindakan_rajal.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and jns_perawatan.nm_perawatan like ? or "
					+ "tindakan_rajal.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and tindakan_rajal.kd_dokter like ? or "
					+ "tindakan_rajal.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and dokter.nm_dokter like ? or "
					+ "tindakan_rajal.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and tindakan_rajal.nip like ? or "
					+ "tindakan_rajal.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and petugas.nama like ? or "
					+ "tindakan_rajal.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and tgl_perawatan like ?  "
					+ " order by tindakan_rajal.no_rawat desc");
			try {
		...
		try {
			...
			for (i = 0; i < TabModeTindakan.getRowCount(); i++) {
				if (TabModeTindakan.getValueAt(i, 0).toString().equals("true")) {
					...
					jnsBayar[index] = TabModeTindakan.getValueAt(i, 11).toString();
					index++;
				}
			}
			...
			if (poli_ralan.equals("Yes") && cara_bayar_ralan.equals("Yes")) {
				...
				pstindakan = koneksi.prepareStatement(
						"select nm_poli,jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"
								+ "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"
								+ "jns_perawatan.tarif_tindakandr,jns_perawatan.tarif_tindakanpr,jns_perawatan.kso,jns_perawatan.menejemen,png_jawab from jns_perawatan Inner join poliklinik on poliklinik.kd_poli=jns_perawatan.kd_poli inner join kategori_perawatan "
		...
		try {
			...
			for (i = 0; i < TabModeTindakan2.getRowCount(); i++) {
				if (TabModeTindakan2.getValueAt(i, 0).toString().equals("true")) {
					...
					jnsBayar[index] = TabModeTindakan2.getValueAt(i, 1).toString();
					index++;
				}
			}
		...
		try {
			...
			for (i = 0; i < jml; i++) {
				TabModeTindakan3.addRow(new Object[] { pilih[i], kode[i], nama[i], kategori[i], totaltnd[i],
						bagianrs[i], bhp[i], jmdokter[i], jmperawat[i], kso[i], menejemen[i], jnsBayar[i] });
			}
			...
			if (poli_ralan.equals("Yes") && cara_bayar_ralan.equals("Yes")) {
				...
				pstindakan = koneksi.prepareStatement(
						"select nm_poli,jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"
								+ "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"
								+ "jns_perawatan.tarif_tindakandr,jns_perawatan.tarif_tindakanpr,jns_perawatan.kso,jns_perawatan.menejemen,png_jawab from jns_perawatan inner join kategori_perawatan Inner join poliklinik on poliklinik.kd_poli=jns_perawatan.kd_poli "
								+ "on jns_perawatan.kd_kategori=kategori_perawatan.kd_kategori Inner join penjab on penjab.kd_pj=jns_perawatan.kd_pj INNER join reg_periksa on reg_periksa.kd_pj=penjab.kd_pj and no_rawat='"
								+ TNoRw.getText() + "' "
			...
			try {
				...
				while (rstindakan.next()) {
					TabModeTindakan3.addRow(new Object[] { false, rstindakan.getString(1), rstindakan.getString(2),
							...
							rstindakan.getDouble("menejemen"), rstindakan.getString("png_jawab") });
				}
			} catch (Exception e) {
				System.out.println("Notifikasi : " + e);
			} finally {
		...
		try {
			...
			for (i = 0; i < tbTindakan3.getRowCount(); i++) {
				if (tbTindakan3.getValueAt(i, 0).toString().equals("true")) {
					System.out.println("Kode perawatan"+tbTindakan3.getValueAt(i, 1).toString());
