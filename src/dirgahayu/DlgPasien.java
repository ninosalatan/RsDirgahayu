...
public class DlgPasien extends javax.swing.JDialog {
	...
	private TextBox Carialamat;
	private TextBox TCari;
	private ComboBox cmbHlm;
	private panelisi panelGlass9;
	private Label jLabel6;
	private TextBox textNamaSeacrh;
	private TextBox txtPenjamin;
	private TextBox txtTlp;
	private Tanggal DTPLahirS;
	private JRadioButton rdbtnSearch;
	private JRadioButton rdbtnSearch1;
	private JRadioButton rdbtnSearch2;
	private JRadioButton rdbtnSearch3;
...
//		}
	...
	private void initComponents() {
		...
		PekerjaanPj = new widget.ComboBox();
		...
		internalFrame4.setLocation(6, 11);
		...
		String kdBhs = Sequel.cariIsi("select id from bahasa_pasien where nama_bahasa='Indonesia' ");

		kdbahasa.setText(kdBhs);
		String nmBhs = Sequel.cariIsi("select nama_bahasa from bahasa_pasien where nama_bahasa='Indonesia' ");
		nmbahasa.setText(nmBhs);
		...
		Sequel.addItemCombo("Select nm_pekerjaan from pekerjaan order by nm_pekerjaan ASC", PekerjaanPj);
		...
		jRadioButton1.setText("Set Alamat Sama");
		...
		jRadioButton1.setBounds(880, 250, 130, 23);
...
//        Search pasien
		panelSearch = new widget.panelisi();
		panelSearch.setBorder(null);
		panelSearch.setName("panelSearch"); // NOI18N
		panelSearch.setPreferredSize(new java.awt.Dimension(560, 180));
		...
		PanelInput.add(panelSearch, java.awt.BorderLayout.CENTER);

		Label lblNamaSearch = new Label();
		lblNamaSearch.setHorizontalAlignment(SwingConstants.LEFT);
		lblNamaSearch.setText("Nama :");
		lblNamaSearch.setBounds(51, 11, 100, 14);
		panelSearch.add(lblNamaSearch);

		rdbtnSearch = new JRadioButton("1");
		rdbtnSearch.setBounds(6, 7, 39, 23);
		rdbtnSearch.setName("RdSeach");
		panelSearch.add(rdbtnSearch);

		textNamaSeacrh = new TextBox();
		textNamaSeacrh.setBounds(140, 11, 335, 25);
		textNamaSeacrh.setEditable(false);
		textNamaSeacrh.setBackground(new java.awt.Color(245, 250, 240));
		textNamaSeacrh.setHighlighter(null);
		textNamaSeacrh.setName("textNamaSeacrh"); // NOI18N
		textNamaSeacrh.setOpaque(true);
		textNamaSeacrh.addKeyListener(new java.awt.event.KeyAdapter() {
			@Override
			public void keyPressed(java.awt.event.KeyEvent evt) {
...
//		showPatient
		panelSearch.add(textNamaSeacrh);

		Label lblAlamatSearch = new Label();
		lblAlamatSearch.setHorizontalAlignment(SwingConstants.LEFT);
		lblAlamatSearch.setBounds(51, 47, 100, 14);
		lblAlamatSearch.setText("Alamat :");
		panelSearch.add(lblAlamatSearch);

		Carialamat = new TextBox();
		Carialamat.setBounds(140, 42, 335, 25);
		Carialamat.setEditable(false);
		Carialamat.setBackground(new java.awt.Color(245, 250, 240));
		Carialamat.setHighlighter(null);
		Carialamat.setName("Carialamat");
		Carialamat.setOpaque(true);
		...
		panelSearch.add(Carialamat);
		
		txtPenjamin = new TextBox();
		txtPenjamin.setBounds(140, 78, 335, 25);
		txtPenjamin.setEditable(false);
		txtPenjamin.setBackground(new java.awt.Color(245, 250, 240));
		txtPenjamin.setHighlighter(null);
		txtPenjamin.setName("txtPenjamin");
		txtPenjamin.setOpaque(true);
		txtPenjamin.addKeyListener(new java.awt.event.KeyAdapter() {
			@Override
			public void keyPressed(java.awt.event.KeyEvent evt) {
				if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
					showPatient();
		...
		panelSearch.add(txtPenjamin);

		rdbtnSearch.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (++clickCount % 2 == 0) {
					...
					txtTlp.setBackground(new java.awt.Color(245, 250, 240));
					txtTlp.setHighlighter(null);
					txtTlp.setText("");
					TCari.setEditable(false);
					TCari.setBackground(new java.awt.Color(245, 250, 240));
					...
					DTPLahirS.setEnabled(false);
				} else {
					textNamaSeacrh.setEditable(true);
					textNamaSeacrh.setBackground(new java.awt.Color(255, 255, 255));
					textNamaSeacrh.setHighlighter(null);
					Carialamat.setEditable(true);
					Carialamat.setBackground(new java.awt.Color(255, 255, 255));
					Carialamat.setHighlighter(null);
					txtPenjamin.setEditable(true);
					txtPenjamin.setBackground(new java.awt.Color(255, 255, 255));
					txtPenjamin.setHighlighter(null);
					//
					DTPLahirS.setEnabled(false);
					txtTlp.setEditable(false);
		...
		rdbtnSearch1 = new JRadioButton("2");
		rdbtnSearch1.setBounds(485, 11, 39, 23);
		rdbtnSearch1.setName("RdSeach");
		panelSearch.add(rdbtnSearch1);
		rdbtnSearch1.addActionListener(new java.awt.event.ActionListener() {
			private int clickCount;
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (++clickCount % 2 == 0) {
					...
					txtTlp.setBackground(new java.awt.Color(255, 255, 255));
					txtTlp.setHighlighter(null);
					//
					TCari.setEditable(false);
					TCari.setBackground(new java.awt.Color(245, 250, 240));
		...
		Label lblPhoneSearch = new Label();
		lblPhoneSearch.setHorizontalAlignment(SwingConstants.LEFT);
		lblPhoneSearch.setBounds(530, 15, 100, 14);
		lblPhoneSearch.setText("No Tlp/Hp/NIK");
		panelSearch.add(lblPhoneSearch);

		txtTlp = new TextBox();
		txtTlp.setBounds(619, 11, 335, 25);
		txtTlp.setEditable(false);
		txtTlp.setBackground(new java.awt.Color(245, 250, 240));
		txtTlp.setHighlighter(null);
		txtTlp.setName("txtTlp");
		txtTlp.setOpaque(true);
		...
		panelSearch.add(txtTlp);

		rdbtnSearch2 = new JRadioButton("3");
		rdbtnSearch2.setBounds(485, 47, 39, 23);
		rdbtnSearch2.setName("RdSeach");
		panelSearch.add(rdbtnSearch2);
		rdbtnSearch2.addActionListener(new java.awt.event.ActionListener() {
			private int clickCount;
		...
		rdbtnSearch3 = new JRadioButton("4");
		rdbtnSearch3.setBounds(485, 79, 39, 23);
		rdbtnSearch3.setName("RdSeach");
		panelSearch.add(rdbtnSearch3);
		rdbtnSearch3.addActionListener(new java.awt.event.ActionListener() {
			private int clickCount;
		...
		btnGrp.add(rdbtnSearch3);
		btnGrp.add(rdbtnSearch2);
		btnGrp.add(rdbtnSearch1);
		btnGrp.add(rdbtnSearch);
		Label lbltgleSearch = new Label();
		lbltgleSearch.setHorizontalAlignment(SwingConstants.LEFT);
		lbltgleSearch.setBounds(530, 47, 100, 14);
		lbltgleSearch.setText("Tanggal Lahir :");
		panelSearch.add(lbltgleSearch);

		DTPLahirS.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-03-2021" }));
		DTPLahirS.setDisplayFormat("dd-MM-yyyy");
		DTPLahirS.setName("DTPLahirS");
		DTPLahirS.setOpaque(false);
		DTPLahirS.setEnabled(false);

		DTPLahirS.setBounds(619, 47, 100, 23);
		panelSearch.add(DTPLahirS);

		Label lblRmSearch = new Label();
		lblRmSearch.setHorizontalAlignment(SwingConstants.LEFT);
		lblRmSearch.setBounds(530, 79, 100, 14);
		lblRmSearch.setText("No. RM :");
		panelSearch.add(lblRmSearch);

		TCari = new TextBox();
		TCari.setBounds(619, 78, 335, 25);
		TCari.setEditable(false);
		TCari.setBackground(new java.awt.Color(245, 250, 240));
		TCari.setHighlighter(null);
		TCari.setName("TCari");
		TCari.setOpaque(true);
		...
		BtnCari.setBounds(418, 122, 120, 30);
		...
		Label lblpnjJawab = new Label();
		lblpnjJawab.setHorizontalAlignment(SwingConstants.LEFT);
		lblpnjJawab.setBounds(51, 78, 100, 14);
		lblpnjJawab.setText("Penj. Jawab");
		panelSearch.add(lblpnjJawab);
		...
		cmbHlm.addItemListener(new java.awt.event.ItemListener() {
			@Override
			public void itemStateChanged(java.awt.event.ItemEvent evt) {
				LimitItemsStateChanged(evt);
			}

			private void LimitItemsStateChanged(ItemEvent evt) {
				// TODO Auto-generated method stub
//				tampil();
				showPatient();
			}
		...
		ChkInput.setMnemonic('s');
		ChkInput.setText(".: Cari Data");
		...
		FormPhoto.setBorder(javax.swing.BorderFactory.createTitledBorder(
				javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), " Photo Pasien : ",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
		...
		FormPass.setBorder(javax.swing.BorderFactory.createTitledBorder(
				javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), " Password EPasien : ",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
	...
	private void KdpnjKeyPressed(java.awt.event.KeyEvent evt) {                                 
	...
	protected void DTPLahirsKeyPressed(KeyEvent evt) {
		// TODO Auto-generated method stub

	}

	protected void DTPLahirItemsStateChanged(ItemEvent evt) {
		// TODO Auto-generated method stub
	...
	protected void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {
	...
	private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpanActionPerformed
		if (TNo.getText().trim().equals("")) {
			...
			Valid.textKosong(TKtp, "No.KTP/SIM minimal " + 16 + " ");
		...
		} else if (pekerjaan.equals("Yes") && (Pekerjaan.getSelectedItem().toString().trim().length() < p_pekerjaan)) {
...
//        }
			...
			if (Kelurahan.isEditable() == true) {
				Sequel.queryu4("insert into kelurahan values(?,?)", 2,
						new String[] { "0", Kelurahan.getText().replaceAll("KELURAHAN", "-") });
			...
			if (Kecamatan.isEditable() == true) {
				Sequel.queryu4("insert into kecamatan values(?,?)", 2,
						new String[] { "0", Kecamatan.getText().replaceAll("KECAMATAN", "-") });
			...
			if (Kabupaten.isEditable() == true) {
				Sequel.queryu4("insert into kabupaten values(?,?)", 2,
						new String[] { "0", Kabupaten.getText().replaceAll("KABUPATEN", "-") });
			...
			if (Propinsi.isEditable() == true) {
				Sequel.queryu4("insert into propinsi values(?,?)", 2,
						new String[] { "0", Propinsi.getText().replaceAll("PROPINSI", "-") });
			...
			if (Sequel.menyimpantf2("pasien", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
					...
					new String[] { TNo.getText(), TNm.getText(), TKtp.getText(),
							...
							Pekerjaan.getSelectedItem().toString(), CmbStts.getSelectedItem().toString(),
							cmbAgama.getSelectedItem().toString(),dateNow,
							TTlp.getText(),
							...
							TNoPeserta.getText(), kdkel, kdkec, kdkab, PekerjaanPj.getSelectedItem().toString(),
					...
					if (Sequel.menyimpantf2("pasien",
						...
						if (Sequel.menyimpantf2("pasien",
								...
								new String[] { TNo.getText(), TNm.getText(), TKtp.getText(),
										...
										PekerjaanPj.getSelectedItem().toString(), AlamatPj.getText(),
							...
							if (chkPolri.isSelected() == true) {
								Sequel.menyimpan2("pasien_polri", "?,?,?,?,?,?", "Data", 5,
										new String[] { TNo.getText(), kdgolonganpolri.getText(),
												kdpangkatpolri.getText(), kdsatuanpolri.getText(),
							...
							if (Sequel.menyimpantf("pasien",
									...
									new String[] { TNo.getText(), TNm.getText(), TKtp.getText(),
											...
											CMbGd.getSelectedItem().toString(), Pekerjaan.getSelectedItem().toString(),
								...
								if (chkTNI.isSelected() == true) {
									Sequel.menyimpan2("pasien_tni", "?,?,?,?,?", "Data", 5,
											new String[] { TNo.getText(), kdgolongantni.getText(),
													kdpangkattni.getText(), kdsatuantni.getText(),
													kdjabatantni.getText() });
								}
								if (chkPolri.isSelected() == true) {
									Sequel.menyimpan2("pasien_polri", "?,?,?,?,?,?", "Data", 5,
											new String[] { TNo.getText(), kdgolonganpolri.getText(),
...
//			tampil();
	...
	private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnEditActionPerformed
		if (TNo.getText().trim().equals("")) {
			...
			Valid.textKosong(Kabupaten, "Kabupaten minimal " + p_kabupaten + " karakter dan ");
		} else if (pekerjaanpj.equals("Yes")
				&& (PekerjaanPj.getSelectedItem().toString().trim().length() < p_pekerjaanpj)) {
			Valid.textKosong(PekerjaanPj, "Pekerjaan P.J. minimal " + p_pekerjaanpj + " karakter dan ");
		} else if (alamatpj.equals("Yes") && (AlamatPj.getText().trim().length() < p_alamatpj)) {
			Valid.textKosong(AlamatPj, "Alamat P.J. minimal " + p_alamatpj + " karakter dan ");
		} else if (kelurahanpj.equals("Yes") && (KelurahanPj.getText().trim().length() < p_kelurahanpj)) {
			...
			if (Sequel.mengedittf("pasien", "no_rkm_medis=?", "no_rkm_medis=?,nm_pasien=?,no_ktp=?,jk=?,tmp_lahir=?,"
					...
					new String[] { TNo.getText(), TNm.getText(), TKtp.getText(),
							...
							Sequel.cariIsi("select kabupaten.kd_kab from kabupaten where kabupaten.nm_kab=?",
									Kabupaten.getText()),
							NmIbu.getText(), PekerjaanPj.getSelectedItem().toString(), AlamatPj.getText(),
					...
					if (Carialamat.getText().trim().equals("") && TCari.getText().trim().equals("")) {
						...
						Valid.MyReportqry("rptPasien.jasper", "report", "::[ Data Pasien Umum ]::",
								"select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
										...
										+ Carialamat.getText().trim() + "%' and pasien.no_rkm_medis like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.nm_pasien like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.no_ktp like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.no_peserta like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.tmp_lahir like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.tgl_lahir like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and penjab.png_jawab like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.alamat like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.gol_darah like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.pekerjaan like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.stts_nikah like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.nip like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and cacat_fisik.nama_cacat like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.namakeluarga like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim()
										+ "%'  and perusahaan_pasien.nama_perusahaan like '%" + TCari.getText().trim()
										+ "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and bahasa_pasien.nama_bahasa like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and suku_bangsa.nama_suku_bangsa like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.agama like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.nm_ibu like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.tgl_daftar like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.no_tlp like '%"
					...
					if (Carialamat.getText().trim().equals("") && TCari.getText().trim().equals("")) {
						...
						Valid.MyReportqry("rptPasien2.jasper", "report", "::[ Data Pasien Umum ]::",
								"select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
										...
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and golongan_tni.nama_golongan like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and satuan_tni.nama_satuan like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pangkat_tni.nama_pangkat like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and jabatan_tni.nama_jabatan like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.nip like '%"
										+ TCari.getText().trim() + "%' "
					...
					if (Carialamat.getText().trim().equals("") && TCari.getText().trim().equals("")) {
						...
						Valid.MyReportqry("rptPasien3.jasper", "report", "::[ Data Pasien Umum ]::",
								"select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
										...
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and golongan_polri.nama_golongan like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and satuan_polri.nama_satuan like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pangkat_polri.nama_pangkat like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and jabatan_polri.nama_jabatan like '%"
										+ TCari.getText().trim() + "%' "
										+ "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
										+ Carialamat.getText().trim() + "%'  and pasien.nip like '%"
										+ TCari.getText().trim() + "%' "
...
//				tampil();
	...
	private void MnViaDukcapilNikDKIActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_MnViaDukcapilNikDKIActionPerformed
		if (TKtp.getText().trim().equals("")) {
			...
			this.setCursor(Cursor.getDefaultCursor());
			if ((Kelurahan.isEditable() == false) || (Kecamatan.isEditable() == false)
					|| (Kabupaten.isEditable() == false) || (Propinsi.isEditable() == false)) {
				JOptionPane.showMessageDialog(null,
	...
	private void btnUbahPasswordActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnUbahPasswordActionPerformed
		if (NoRekamMedisDipilih.getText().equals("") || NamaPasienDipilih.getText().equals("")) {
			...
			if (Sequel.menyimpantf("personal_pasien", "?,'',aes_encrypt(?,'windi')", 2,
					new String[] { NoRekamMedisDipilih.getText(), PasswordPasien.getText() }, "no_rkm_medis=?",
					"password=aes_encrypt(?,'windi')", 2,
					new String[] { PasswordPasien.getText(), NoRekamMedisDipilih.getText() }) == true) {
	...
	private void btnAmbilPhotoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAmbilPhotoActionPerformed
		...
		if (NoRekamMedisDipilih.getText().equals("") || NamaPasienDipilih.getText().equals("")) {
			...
			Valid.panggilUrl("photopasien/login.php?act=login&usere=admin&passwordte=akusayangsamakamu&norm="
	...
	private JCheckBox chckbxPenjamin1;
	private JCheckBox chckbxPenjamin2;
...
//			
			String LimitFilter;
			if (cmbHlm.getSelectedItem().toString().equals("Semua")) {
				LimitFilter = "  order by pasien.no_rkm_medis desc";
			} else {
				LimitFilter = "  order by pasien.no_rkm_medis desc Limit "
						+ Integer.parseInt(cmbHlm.getSelectedItem().toString());
			}

			if (rdbtnSearch.isSelected() == true) {
				if (!textNamaSeacrh.getText().trim().equals("") && !Carialamat.getText().trim().equals("")&&txtPenjamin.getText().trim().equals("")) {
					Filter = "where pasien.nm_pasien like '%" + textNamaSeacrh.getText()
							+ "%' and concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
							+ Carialamat.getText() + "%'";
				} else if (textNamaSeacrh.getText().trim().equals("") && !Carialamat.getText().trim().equals("")&&txtPenjamin.getText().trim().equals("")) {
					Filter = "where concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%"
							+ Carialamat.getText() + "%'";
				} else if (!textNamaSeacrh.getText().trim().equals("") && Carialamat.getText().trim().equals("")) {
					Filter = "where pasien.nm_pasien like '%" + textNamaSeacrh.getText() + "%'";
				} else if(!txtPenjamin.getText().trim().equals("")&&textNamaSeacrh.getText().trim().equals("")&&Carialamat.getText().trim().equals("")){
					Filter = "where namakeluarga like '%"+txtPenjamin.getText()+"%'";
				}else if(!txtPenjamin.getText().trim().equals("")&&!textNamaSeacrh.getText().trim().equals("")&&Carialamat.getText().trim().equals("")){
					Filter = "where namakeluarga like '%"+txtPenjamin.getText()+"%' and pasien.nm_pasien like '%" + textNamaSeacrh.getText() + "%'";
				}else if(!txtPenjamin.getText().trim().equals("")&&textNamaSeacrh.getText().trim().equals("")&&!Carialamat.getText().trim().equals("")){
					Filter = "where namakeluarga like '%"+txtPenjamin.getText()+"%' and concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + textNamaSeacrh.getText() + "%'";
				}

			} else if (rdbtnSearch1.isSelected() == true) {
				if (!txtTlp.getText().trim().equals("")) {
					Filter = "where pasien.no_tlp like '%" + txtTlp.getText() + "%' or pasien.no_ktp='"
							+ txtTlp.getText() + "'";
				}
			} else if (rdbtnSearch2.isSelected() == true) {
				Filter = "where pasien.tgl_lahir = '" + Valid.SetTgl(DTPLahirS.getSelectedItem().toString()) + "'";
			} else if (rdbtnSearch3.isSelected() == true) {
				if (!TCari.getText().trim().equals("")) {
					Filter = "where pasien.no_rkm_medis like '%" + TCari.getText() + "%'";
				}
			} else {
			...
			query = "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk,"
					...
					+ "	inner join cacat_fisik on pasien.cacat_fisik=cacat_fisik.id inner join propinsi on pasien.kd_prop=propinsi.kd_prop"
					+ "	inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien inner join suku_bangsa on suku_bangsa.id=pasien.suku_bangsa "
					+ "	left join penjab on pasien.kd_pj=penjab.kd_pj  " + Filter + LimitFilter;
//			System.out.println(query);
	...
	public void emptTeks() {
		...
		PekerjaanPj.setSelectedIndex(0);
		TTlp.setText("");
		TUmurTh.setText("");
		Saudara.setText("");
		NmIbu.setText("");
			...
			try {
				...
				try {
					...
					if (rs.next()) {
						...
						PekerjaanPj.setSelectedItem(rs.getString("pekerjaanpj"));
				...
				Pekerjaan.setSelectedItem(tbPasien.getValueAt(tbPasien.getSelectedRow(), 10).toString());
	...
	private void getDataTni() {
		if (tbPasien2.getSelectedRow() != -1) {
			try {
				...
				Pekerjaan.setSelectedItem(tbPasien2.getValueAt(tbPasien2.getSelectedRow(), 10).toString());
	...
	private void getDataPolri() {
		if (tbPasien3.getSelectedRow() != -1) {
			try {
				...
				Pekerjaan.setSelectedItem(tbPasien3.getValueAt(tbPasien3.getSelectedRow(), 10).toString());
...
//			tampil();
	...
	private void panggilPhoto() {
		if (FormPhotoPass.isVisible() == true) {
			try {
				ps = koneksi.prepareStatement(
						"select gambar,aes_decrypt(password,'windi') as password from personal_pasien where no_rkm_medis=?");
				try {
