...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModeDr=new DefaultTableModel(null,new Object[]{
            "P","No.Rawat","No.R.M.","Nama Pasien","Perawatan/Tindakan","Kode Dokter","Dokter Yg Menangani","Tgl.Rawat","Jam Rawat","Biaya","Kode","Tarif Dokter","KSO","Jasa Sarana","BHP","Menejemen","Jenis Bayar"}){
        ...
        tabModePr=new DefaultTableModel(null,new Object[]{
            "P","No.Rawat","No.R.M.","Nama Pasien","Perawatan/Tindakan","NIP","Petugas Yg Menangani","Tgl.Rawat","Jam Rawat","Biaya","Kode","Tarif Perawat","KSO","Jasa Sarana","BHP","Menejemen","jenis Bayar"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
        ...
        tabModeDrPr=new DefaultTableModel(null,new Object[]{
            ...
            "Biaya","Kode","Tarif Dokter","Tarif Petugas","KSO","Jasa Sarana","BHP","Menejemen","Jenis Bayar"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
...
//        }
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                if(!TPerawat2.getText().trim().equals("")){
                	btnTindakan7ActionPerformed(null);
                }else {
        ...
        try{
            if(TCari.getText().equals("")&&TCariPasien.getText().equals("")){
                ps=koneksi.prepareStatement("select rawat_inap_dr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                   ...
                   "rawat_inap_dr.tarif_tindakandr,rawat_inap_dr.kso,rawat_inap_dr.material,rawat_inap_dr.bhp,rawat_inap_dr.menejemen,png_jawab "+
                   "from pasien inner join reg_periksa inner join jns_perawatan_inap inner join "+
                   "dokter inner join rawat_inap_dr "+
                   "on rawat_inap_dr.no_rawat=reg_periksa.no_rawat "+
                   "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                   "and rawat_inap_dr.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "+
                   "and rawat_inap_dr.kd_dokter=dokter.kd_dokter Inner join penjab on penjab.kd_pj=jns_perawatan_inap.kd_pj "+
        ...
        try{
            if(TCari.getText().equals("")&&TCariPasien.getText().equals("")){
                ps3=koneksi.prepareStatement("select rawat_inap_drpr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "
                		...
                		+ "rawat_inap_drpr.tarif_tindakandr,rawat_inap_drpr.tarif_tindakanpr,rawat_inap_drpr.kso,rawat_inap_drpr.material,rawat_inap_drpr.bhp,rawat_inap_drpr.menejemen,png_jawab  "
                		+ "from pasien  "
                		...
                		+ "inner join petugas on petugas.nip=rawat_inap_drpr.nip "
                		+ "where rawat_inap_drpr.tgl_perawatan between ? and ? order by rawat_inap_drpr.no_rawat des");
            }else{
                ps3=koneksi.prepareStatement("select rawat_inap_drpr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "
                		+ "concat(rawat_inap_drpr.kd_jenis_prw,' ',jns_perawatan_inap.nm_perawatan),rawat_inap_drpr.kd_dokter,dokter.nm_dokter, "
                		+ "rawat_inap_drpr.nip,petugas.nama,rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,rawat_inap_drpr.biaya_rawat,rawat_inap_drpr.kd_jenis_prw,   "
...
//                  System.out.println(ps3);
                ...
                while(rs.next()){
                    tabModeDrPr.addRow(new Object[]{
                        ...
                        rs.getString("material"),rs.getString("bhp"),rs.getString("menejemen"),rs.getString("png_jawab")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : "+e);
