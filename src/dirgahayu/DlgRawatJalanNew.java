...
public class DlgRawatJalanNew extends JDialog {
	...
	private Button Btndarah;
	private Button BtnOksigen;
	...
	public static void main(String[] args) {
		java.awt.EventQueue.invokeLater(() -> {
			DlgRawatJalanNew dialog = new DlgRawatJalanNew(new javax.swing.JFrame(), true);
	 ...
	 * Create the dialog.
	 */
	public DlgRawatJalanNew(java.awt.Frame parent, boolean modal) {
...
//		End Catatan
		...
		Btndarah = new widget.Button();
		Btndarah.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				DlgTransfusiDarah utd=new DlgTransfusiDarah (null,false);				
				utd.SetNoRm(TNoRw.getText(),"Ralan");
				utd.setSize(internalFrameMain.getWidth() - 20, internalFrameMain.getHeight() - 20);
				utd.setLocationRelativeTo(internalFrameMain);
				utd.setVisible(true);
			}
		});
		Btndarah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
		Btndarah.setText("Tranfusi Darah");
		Btndarah.setFocusPainted(false);
		Btndarah.setFont(new java.awt.Font("Tahoma", 0, 11));
		Btndarah.setGlassColor(new java.awt.Color(255, 255, 255));
		Btndarah.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
		Btndarah.setMargin(new java.awt.Insets(1, 1, 1, 1));
		Btndarah.setName("BtnOksigen");
		Btndarah.setPreferredSize(new java.awt.Dimension(145, 23));
		Btndarah.setRoundRect(false);
		FormMenu.add(Btndarah);
		
		BtnOksigen = new widget.Button();
		BtnOksigen.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				DlgOksigen o2=new DlgOksigen (null,false);				
				o2.SetNoRm(TNoRw.getText(),"Ralan");
				o2.setSize(internalFrameMain.getWidth() - 20, internalFrameMain.getHeight() - 20);
				o2.setLocationRelativeTo(internalFrameMain);
				o2.setVisible(true);
			}
		});
		BtnOksigen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
		BtnOksigen.setText("Oksigen");
		BtnOksigen.setFocusPainted(false);
		BtnOksigen.setFont(new java.awt.Font("Tahoma", 0, 11));
		BtnOksigen.setGlassColor(new java.awt.Color(255, 255, 255));
		BtnOksigen.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
		BtnOksigen.setMargin(new java.awt.Insets(1, 1, 1, 1));
		BtnOksigen.setName("BtnOksigen");
		BtnOksigen.setPreferredSize(new java.awt.Dimension(145, 23));
		BtnOksigen.setRoundRect(false);
		FormMenu.add(BtnOksigen);
...
//		Sequel.mengedit("reg_periksa", "no_rawat=?", "stts=?", 2, new String[] { "Sudah", TNoRw.getText() });
	...
	public void isCek() {
		...
		BtnAwalKeperawatanBayiAnak.setVisible(akses.getpenilaian_awal_keperawatan_anak());
		BtnAwalKeperawatanGigi.setVisible(akses.getpenilaian_awal_keperawatan_gigi());
		BtnPeniliaianAwalKeperawatanKebidanan.setVisible(akses.getpenilaian_awal_keperawatan_kebidanan());
		Btndarah.setVisible(akses.getLabu_darah());
		BtnOksigen.setVisible(akses.getOksiegen());
		//
